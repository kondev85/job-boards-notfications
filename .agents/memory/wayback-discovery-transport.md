...
**How to apply:** If a refresh stalls at the Wayback query, test the HTTPS endpoint first. Workday CDX scans should also keep a bounded per-environment limit so a large archive response cannot block imports indefinitely.